/**
 * This program computes the smallest number of knight moves between two given squares of a chessboard.
 * @author EFE ACER
 */
 ...
 * @param chessboard The chessboard represented as a two dimensional array of integers.
 ...
 * and returns it.
 * @param knightSquare The string representation of the knight's position.
 ...
 * @param pos The specified square to be checked.
