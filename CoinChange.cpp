/**
 * Given a set of coins and a target amount of money, this program computes the way of changing this money
...
//Main Method
int main() {
    cout << "Given a set of coins and a target amount of money, this program computes"
    " the way of changing this money with the smallest number of coins. (it is assumed that"
    " the inputs are comformable (logical).)\n\n";
